...
const UserPage = (props) => {
    ...
    return (
        <div className={styles.mapContainer}>
            <h1 className={styles.userPageTitle}>{user.name}'s Dashboard</h1>
            {homicideStats.length ? 
            <>
            {window.innerWidth >= 960 ? 
            <div className={styles.userMapText}>
                <div className={styles.hoodMap}>
                    <div className={styles.hoodNameTitle}>
                        <h3 className={styles.userHoodsH3}>{user.homeHood}</h3>
                    </div>
                    <div className={styles.userMapText}>
                ...
                <div className={styles.hoodMap}>
                    <div className={styles.hoodNameTitle}>
                        <h3 className={styles.userHoodsH3}>{user.workHood}</h3>
                    </div>
                    <div className={styles.userMapText}>
                ...
                <div className={styles.hoodMap}>
                    <div className={styles.hoodNameTitle}>
                        <h3 className={styles.userHoodsH3}>{user.checkHood}</h3>
                    </div>
                    <div className={styles.userMapText}>
                ...
                <div className={styles.searchModal}>
                    ...
                    >
                        <div className={styles.controlModalWrap}>
                            ...
                            <LegendModal />
                            <div className={styles.closeButtonMobileWrap}>
                                <button className={styles.closeButtonMobile} onClick={handleClose}><FaTimesCircle /></button>
                            </div>
                        </div>
                    </Modal>
                </div>
            ...
            :
            <>
            <div className={styles.userMapTextMobile}>
                <div className={styles.hoodMap}>
                    <div className={styles.hoodNameTitle}>
                        <h3 className={styles.userHoodsH3}>{user.homeHood}</h3>
                        <div className={styles.searchModal}>
